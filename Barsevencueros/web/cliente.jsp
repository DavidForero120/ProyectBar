    ...
    <body>
        ...
        <div class="formulario-family" id="formulario-family">
            ...
            <form method="POST" action="Cliente" id="register" class="register">
                ...
                <div id="group_input">
                    <i class="frm-icono fas fa-times-circle"><input type="text" name="cliente_documento" id="cliente_documento" class="cliente_documento"></i><span class="msg_error">Solo puede ingresar numeros de minimo 5 y maximo 10 digitos</span>                  
                </div>           
                </div>
                ...
                <h2>Nombre</h2>
                <div id="group_input">
                <i class="frm-icono fas fa-times-circle"><input type="text" name="cliente_nombre" id="cliente_nombre" class="cliente_nombre"></i>
                ...
                <h2>Apellido</h2>
                <div id="group_input">
                <i class="frm-icono fas fa-times-circle"><input type="text" name="cliente_apellido" id="cliente_apellido" class="cliente_apellido"></i>
                <span class="msg_error">Solo puede ingresar letras y un maximo de 40 caracteres</span>
                </div>
                </div>
                ...
                <div id="group_input">
                <i class="frm-icono fas fa-times-circle"><input type="text" name="cliente_correo" id="cliente_correo" class="cliente_correo"></i>
                ...
                <div class="frm-no-enviado" id="frm-no-enviado">
                    <p><i class="fas fa_times-triangle"></i> <b>Error:</b> Hay campos incompletos o incorrectos.</p>
                </div>
        ...
        /*<script src="assets/js/validacionCliente.js" type="text/javascript"></script>*7
    </body>
</html>
